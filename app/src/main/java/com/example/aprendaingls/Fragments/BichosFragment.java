...
public class BichosFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //criando um objeto do tipo do view recebento o fragment
    ...
    //quando temos muitos botões é recomendado usar o implements View.OnClick
    //esse onClick é global.
    @Override
    ...
    public void tocarSom(){
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                mediaPlayer.release(); //após o término do som, ele libera recursos.
            }
        });
    }
